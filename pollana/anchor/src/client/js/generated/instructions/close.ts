...
export type CloseInput<
  ...
  TAccountPollana extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountPollana>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountPollana> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.pollana),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountPollana>;
